...
class GoodreadsEnhancedSource(IQuoteSource):
    def __init__(self):
    ...
    def get_info(cls):
        return {
            "name": "GoodreadsEnhanced",
            "description": _("Fetches quotes from Goodreads.com with Blacklist"),
            "author": "Peter Levi / James Powell",
            "version": "0.2",
        }
    ...
    def get_from_soup(self, url, soup):
        ...
        for div in soup.find_all("div", {"class": "quoteText"}):
            ...
            try:
                ...
                # check if quote in blacklist
                if quote_not_blacklisted(quote_text, QUOTE_BLACKLIST) and quote_not_blacklisted(author, AUTHOR_BLACKLIST):
                    quotes.append(
